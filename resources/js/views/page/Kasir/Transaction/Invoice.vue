                                                            ...
                                                            <div class="table-responsive">
                                                                <table class="table">
                                                                    ...
                                                                    <tr v-for="order_detail in data_order.details" v-bind:key="order_detail.id">
                                                                        ...
                                                                        <td class="text-center">Rp {{ numberFormat(order_detail.subtotal - order_detail.ppn) }}</td>
                                                                        <td class="text-center">{{ order_detail.quantity }}</td>
                                                                        <td class="text-right">Rp {{ numberFormat(order_detail.subtotal - order_detail.ppn)}}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="no-line"></td>
                                                                        <td class="no-line"></td>
